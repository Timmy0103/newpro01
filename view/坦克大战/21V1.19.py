...
V1.19
    优化功能：
            1、实现坦克与墙壁之间的碰撞检测（坦克不能窗墙）
            2、我方坦克与敌方坦克的碰撞检测
                1、我方坦克主动碰撞到敌方坦克（我方坦克stay）
                2、敌方坦克主动碰撞到敌方坦克（敌方坦克stay）
'''
...
class MainGame():
    ...
    def creatMyTank(self):
        # 创建我方坦克
        MainGame.TANK_P1 = MyTank(375, 440)
    # 创建敌方坦克
...
class Explode():
    def __init__(self,tank):
        ...
        self.step = 0
        self.images = [
            pygame.image.load('E:/1tank/explode1.png'),
            pygame.image.load('E:/1tank/explode2.png'),
            pygame.image.load('E:/1tank/explode3.png')
        ]
...
class Wall():
    def __init__(self,left,top):
        self.image = pygame.image.load('E:/1tank/wall1.png')
        self.rect = self.image.get_rect()
        self.rect.left = left
        self.rect.top = top
        # 用来判断墙壁是否应该在窗口中展示
